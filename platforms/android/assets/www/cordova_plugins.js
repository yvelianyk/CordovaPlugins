...
module.exports = [
  ...
  {
    "id": "cordova-plugin-fingerprint-id.TouchID",
    "file": "plugins/cordova-plugin-fingerprint-id/www/TouchID.js",
    "pluginId": "cordova-plugin-fingerprint-id",
    "clobbers": [
      "window.plugins.touchid"
    ]
  },
  {
    "id": "cordova-plugin-fingerprint-id.SamsungPass",
    "file": "plugins/cordova-plugin-fingerprint-id/www/SamsungPass.js",
    "pluginId": "cordova-plugin-fingerprint-id",
    "clobbers": [
      "window.plugins.SamsungPass"
    ]
  },
  {
...
// TOP OF METADATA
{
  ...
  "cordova-plugin-apteligent": "3.3.2",
  "cordova-plugin-device": "2.0.1",
  "cordova-plugin-fingerprint-id": "0.3.0",
